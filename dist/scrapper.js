    ...
    getRandomFrame() {
        return __awaiter(this, void 0, void 0, function* () {
            yield axios_1.default
                ...
                yield (0, node_fetch_1.default)(imgUrl).then(res => {
                    if (res)
                        res.body.pipe(fs.createWriteStream(`./to-post/${Episode}-${Timestamp}.jpg`));
                });
            }))
                .catch((error) => {
                console.log(error);
